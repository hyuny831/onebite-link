  ...
  return (
    <aside className="hidden w-56 shrink-0 flex-col gap-1 border-r border-zinc-200 px-3 py-6 sm:flex dark:border-zinc-800">
      ...
      <button
        ...
        className="mt-auto flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium text-zinc-600 transition-colors hover:bg-zinc-100 disabled:cursor-not-allowed disabled:opacity-50 dark:text-zinc-300 dark:hover:bg-zinc-900"
      >
